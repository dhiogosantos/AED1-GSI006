/*
TAD: fila dinâminca encadeada

- Dados: números inteiros

- Lista de operações: criar_fila, fila_vazia, insere_fila, remove_fila, imprime_fila
...
Operações:
    ...
    le final:
        ...
        Saída: nenhuma
        Pós-condição: 0 (sucesso - útlimo elemento obtido) ou -1 (falha - erro ao obter último elemento)
*/
