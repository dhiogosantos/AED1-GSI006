/*
TAD: lista encadeada ordenada com nó cabeçalho
...
Operações:
    ...
    insere_elem_ord:
        Entrada: cópia do endereço de uma lista e o elemento (nro inteiro) a ser inserido
        Pré-condição: lista ser válida
    ...
    obtem_valor_elem:
        ...
        Saída: aux (sucesso - retorna o próprio elemento caso ele pertença a lista) ou -1 (falha - elemento não pertence a lista)
        Pós-condição: nenhuma
