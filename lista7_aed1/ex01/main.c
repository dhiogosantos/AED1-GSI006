...
#include <stdlib.h>
#include <conio.h>
#include "lista_enc_nao_ord_header.h"
    ...
    do{
        ...
        case 2:
            ...
            if(lista_vazia(lst1) == 0)
                ...
                printf("\nA lista não está vazia. Aperte qualquer tecla para continuar...\n\n");
        ...
        case 5:
            ...
            if (res5 == -1)
                printf("\nFalha ao verificar elemento pois lista esta vazia! Aperte qualquer tecla para continuar...\n\n");
            else if(res5 == -2)
