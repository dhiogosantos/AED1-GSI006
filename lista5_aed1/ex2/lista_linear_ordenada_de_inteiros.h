...
TAD lista_linear_ordenada_de_inteiros

    - Dados: números inteiros

    - Lista de operações: criar_lista, lista_vazia, lista_cheia, insere_elem_ordenado, remove_elem e obtem_valor_elem
