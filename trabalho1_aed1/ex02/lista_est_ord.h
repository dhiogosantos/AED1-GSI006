...
TAD lista_est_ord
    ...
    - Lista de operações: create_list, empty_list, full_list, insert_elem_ord, insert_elem, remove_elem_ord, remove_odd, print_list, smallest_elem, list_size, concat_list.
...
Operações:
    ...
    insert_elem_ord:
        ...
        Processo: inserir o elemento na ordem correta na lista
        Saída: 0 (sucesso - elemento inserido na ordem correta) ou -1 (falha - elemento não inserido) 
        Pós-condição: a lista de entrada ordenada com um elemento a mais
