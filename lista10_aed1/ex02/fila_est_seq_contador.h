...
Operações:
    - cria_fila:
        ...
        Processo: cria a fila e a coloca em estado de fila vazia
    ...
    - insere_fim:
        ...
        Pré-condição: fila não estar cheia e existir
    ...
    - remove_ini:
        ...
        Pré-condição: fila não estar vazia e existir
    ...
    - ler_final:
        Entrada: endereço da fila e o endereço de retorno do elemento que esta no fim da fila
        Pré-condição: fila não estar vazia e existir
