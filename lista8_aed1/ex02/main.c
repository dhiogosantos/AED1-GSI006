...
int main(){
    ...
    do{
        ...
        do{
            ...
            printf(" 7. Inserir elemento no inicio\n");
        ...
        case 7:
            printf("\n7. Inserir elemento no inicio\n\n");
            int res7, elem7;

            printf("Digite o elemento a ser inserido: ");
            scanf("%d", &elem7);

            res7 = insert_elem_begin(&list, elem7);

            if(res7 == -1)
                printf("\n\nFalha ao inserir novo elemento. Aperte qualquer tecla para continuar...\n\n");
            else
                printf("\n\nElemento inserido com sucesso. Aperte qualquer tecla para continuar...\n\n");
        ...
        case 8:
            printf("\n 8. Remover elemento no final\n\n");
            int res8, elem8;

            res8 = remove_elem_end(&list, &elem8);

            if(res8 == -1)
                printf("Falha ao remover ultimo elemento! Lista esta vazia. Aperte qualquer tecla para continuar...\n\n");
            else
                printf("Elemento %d removido com sucesso. Aperte qualquer tecla para continuar...\n\n", elem8);           
